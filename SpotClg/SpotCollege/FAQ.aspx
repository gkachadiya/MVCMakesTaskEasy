<%@ Page Title="FAQ" Language="C#" AutoEventWireup="true" CodeBehind="FAQ.aspx.cs" Inherits="SpotCollege.FAQ" %>
                            ...
                            <div class="span8">
                                <nav id="nav-wrap">
                                    <ul class="navigation" id="nav">
                                        ...
                                        <li class="navi_active"><a href="#">FAQ</a></li>
                                    </ul>
                                </nav>
                            </div>
                            <div class="span1">
