...
{
    public partial class AddNewUniversity : System.Web.UI.Page
    {
        ...
        void loadDetails()
        {
            ...
            {
                SpotCollege.DAL.User user = userBll.Get(Request.QueryString["uname"]);
                if (user != null)
                {
                    University university = universityBll.GetByUserName(user.UserName);
                    if (university != null)
                    {
                        //lblEditUniversityName.Text = university.UserName;
                        txtUserName.Enabled = false;
                        hndUniversityId.Value = university.UniversityId.ToString();
                        hndUserName.Value = university.UserName;
                    ...
                    {
                        txtUserName.Text = Request.QueryString["uname"];
                    }
                }
            }
            else
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (university != null)
            {
                ...
                Response.Redirect("UniversityInformation.aspx");
            }
        }
        ...
        protected void btnBasicSave_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(hndUserName.Value))
            {
            ...
            if (fluploadUniversityImage.HasFile)
            {
                ...
                fluploadUniversityImage.SaveAs(ConfigurationManager.AppSettings["ServerPath"] + "Images\\Profile\\" + UniversityImagename);
            ...
            {
                User usr = new User();
                usr = userBll.Get(university.UserName);
