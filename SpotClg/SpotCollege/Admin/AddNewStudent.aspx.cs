    ...
    public partial class AddNewStudent : System.Web.UI.Page
    {
        ...
        void initPage()
        {
            ...
            else if (sec == "EducationPreferences")
            {
                ...
                {
                    Student stud = studentBll.Get(Convert.ToInt32(Request.QueryString["uname"]));
        ...
        void loadPageDetail()
        {
            if (!String.IsNullOrEmpty(Request.QueryString["uname"]))
            {
                ...
                Student student = studentBll.Get(Convert.ToInt32(Request.QueryString["uname"]));
                if (student != null)
                {
                    //Load Basic Detail
                   // lblEditStudentName.Text = student.UserName;
                    hndUserName.Value = student.UserName;
                    ...
                    string[] arr;
                    if (txtBirthDate.Text.Contains('/'))
                        arr = txtBirthDate.Text.Split('/');
                    else
                        arr = txtBirthDate.Text.Split('-');

                    int birthday = Convert.ToInt32(arr[1]);
                    int birthmonth = Convert.ToInt32(arr[0]);
                    int birthyear = Convert.ToInt32(arr[2]);
                    ...
                    {
                        ddldesirefieldofstudy.SelectedValue = student.DesiredFieldofStudy.ToString();
                    }
        ...
        {
            if (!String.IsNullOrEmpty(hndStudentId.Value))
            {
        ...
        void bindACTList()
        {
            if (!String.IsNullOrEmpty(Request.QueryString["uname"]))
            {
                Student std = studentBll.Get(Convert.ToInt32(Request.QueryString["uname"]));
                if (std != null)
                {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (student == null)
            {
                ...
                string birthdate = ddlmonth.SelectedItem.Value + "/" + ddlday.SelectedItem.Value + "/" + ddlyear.SelectedItem.Value;
                student.BirthDate = Convert.ToDateTime(birthdate);
                ...
                int sId = studentBll.GetByUserName(user.UserName).StudentId;
                hndStudentTestId.Value = sId.ToString();
            ...
            else
            {
                ...
                {
                    User usr = new User();
                    usr = userBll.Get(student.UserName);
            ...
            if (fuProfileImage.HasFile)
            {
                ...
                if (!String.IsNullOrEmpty(Request.QueryString["uname"]))
                {
                    ...
                    if (student == null)
                    {
                        ...
                        student.UserName = Request.QueryString["uname"];
        ...
        [WebMethod()]
        public static String[] ACTSave(string TestId, string Composite, string English, string Math, string Reading, string Science, string Writing, string Date, string StudentTestId, string StudentId)
        {
            string str = string.Empty;
            StudentTestBLL studentTestBLL = new StudentTestBLL();
            StudentBLL studentBll = new StudentBLL();
            ...
            if (school == null)
            {
                ...
                stdTest.StudentId = Convert.ToInt32(StudentId);
                ...
                StudentTest lis = studentTestBLL.GetAll().Where(x => x.StudentId == Convert.ToInt32(StudentId) && x.TestId == 2).OrderByDescending(x => x.StudentTestId).FirstOrDefault();
        ...
        [WebMethod()]
        public static String[] SATSave(string TestId, string Reading, string Math, string Writing, string Composite, string Date, string StudentTestId, string StudentId)
        {
            string str = string.Empty;
            StudentTestBLL studentTestBLL = new StudentTestBLL();
            StudentBLL studentBll = new StudentBLL();
            ...
            if (school == null)
            {
                ...
                stdTest.Date = Date;
                studentTestBLL.Save(stdTest);
                StudentTest lis = studentTestBLL.GetAll().Where(x => x.StudentId == Convert.ToInt32(StudentId) && x.TestId == 3).OrderByDescending(x => x.StudentTestId).FirstOrDefault();
        ...
        [WebMethod()]
        public static String[] APSave(string TestId, string Subject, string Score, string Date, string StudentTestId, string StudentId)
        {
            string str = string.Empty;
            StudentTestBLL studentTestBLL = new StudentTestBLL();
            StudentBLL studentBll = new StudentBLL();
            ...
            if (school == null)
            {
                ...
                stdTest.Date = Date;
                studentTestBLL.Save(stdTest);
                StudentTest lis = studentTestBLL.GetAll().Where(x => x.StudentId == Convert.ToInt32(StudentId) && x.TestId == 4).OrderByDescending(x => x.StudentTestId).FirstOrDefault();
        ...
        [WebMethod()]
        public static String[] GRESave(string TestId, string VerbalReasoning, string QuantitativeReasoning, string AnalyticalWriting, string Date, string StudentTestId, string StudentId)
        {
            string str = string.Empty;
            StudentTestBLL studentTestBLL = new StudentTestBLL();
            StudentBLL studentBll = new StudentBLL();
            ...
            if (school == null)
            {
                ...
                stdTest.Date = Date;
                studentTestBLL.Save(stdTest);
                StudentTest lis = studentTestBLL.GetAll().Where(x => x.StudentId == Convert.ToInt32(StudentId) && x.TestId == 5).OrderByDescending(x => x.StudentTestId).FirstOrDefault();
        ...
        [WebMethod()]
        public static String[] GMATSave(string TestId, string Verbal, string QuantitativeReasoning, string Total, string AnalyticalWriting, string Date, string StudentTestId, string StudentId)
        {
            string str = string.Empty;
            StudentTestBLL studentTestBLL = new StudentTestBLL();
            StudentBLL studentBll = new StudentBLL();
            ...
            if (school == null)
            {
                ...
                StudentTest lis = studentTestBLL.GetAll().Where(x => x.StudentId == Convert.ToInt32(StudentId) && x.TestId == 6).OrderByDescending(x => x.StudentTestId).FirstOrDefault();
        ...
        [WebMethod()]
        public static String[] IBSave(string TestId, string Subject, string Score, string Date, string StudentTestId, string StudentId)
        {
            string str = string.Empty;
            StudentTestBLL studentTestBLL = new StudentTestBLL();
            StudentBLL studentBll = new StudentBLL();
            ...
            if (school == null)
            {
                ...
                stdTest.Date = Date;
                studentTestBLL.Save(stdTest);
                StudentTest lis = studentTestBLL.GetAll().Where(x => x.StudentId == Convert.ToInt32(StudentId) && x.TestId == 7).OrderByDescending(x => x.StudentTestId).FirstOrDefault();
        ...
        [WebMethod()]
        public static String[] IELTSSave(string TestId, string Listening, string Reading, string Writing, string Speaking, string Date, string StudentTestId, string StudentId)
        {
            string str = string.Empty;
            StudentTestBLL studentTestBLL = new StudentTestBLL();
            StudentBLL studentBll = new StudentBLL();
            ...
            if (school == null)
            {
                ...
                StudentTest lis = studentTestBLL.GetAll().Where(x => x.StudentId == Convert.ToInt32(StudentId) && x.TestId == 8).OrderByDescending(x => x.StudentTestId).FirstOrDefault();
        ...
        [WebMethod()]
        public static String[] LSATSave(string TestId, string Score, string Date, string StudentTestId, string StudentId)
        {
            string str = string.Empty;
            StudentTestBLL studentTestBLL = new StudentTestBLL();
            StudentBLL studentBll = new StudentBLL();
            ...
            if (school == null)
            {
                ...
                StudentTest lis = studentTestBLL.GetAll().Where(x => x.StudentId == Convert.ToInt32(StudentId) && x.TestId == 9).OrderByDescending(x => x.StudentTestId).FirstOrDefault();
        ...
        [WebMethod()]
        public static String[] MCATSave(string TestId, string Biology, string Physics, string Verbal, string Writing, string Date, string StudentTestId, string StudentId)
        {
            string str = string.Empty;
            StudentTestBLL studentTestBLL = new StudentTestBLL();
            StudentBLL studentBll = new StudentBLL();
            ...
            if (school == null)
            {
                ...
                stdTest.Date = Date;
                studentTestBLL.Save(stdTest);
                StudentTest lis = studentTestBLL.GetAll().Where(x => x.StudentId == Convert.ToInt32(StudentId) && x.TestId == 10).OrderByDescending(x => x.StudentTestId).FirstOrDefault();
        ...
        [WebMethod()]
        public static String[] PSATSave(string TestId, string Reading, string Math, string Writing, string Date, string StudentTestId, string StudentId)
        {
            string str = string.Empty;
            StudentTestBLL studentTestBLL = new StudentTestBLL();
            StudentBLL studentBll = new StudentBLL();
            ...
            if (school == null)
            {
                ...
                StudentTest lis = studentTestBLL.GetAll().Where(x => x.StudentId == Convert.ToInt32(StudentId) && x.TestId == 11).OrderByDescending(x => x.StudentTestId).FirstOrDefault();
        ...
        [WebMethod()]
        public static String[] SAT2Save(string TestId, string Subject, string Score, string Date, string StudentTestId, string StudentId)
        {
            string str = string.Empty;
            StudentTestBLL studentTestBLL = new StudentTestBLL();
            StudentBLL studentBll = new StudentBLL();
            ...
            if (school == null)
            {
                ...
                StudentTest lis = studentTestBLL.GetAll().Where(x => x.StudentId == Convert.ToInt32(StudentId) && x.TestId == 12).OrderByDescending(x => x.StudentTestId).FirstOrDefault();
        ...
        [WebMethod()]
        public static String[] TOEFLInternetbasedSave(string TestId, string Reading, string Listening, string Speaking, string Writing, string Total, string Date, string StudentTestId, string StudentId)
        {
            string str = string.Empty;
            StudentTestBLL studentTestBLL = new StudentTestBLL();
            StudentBLL studentBll = new StudentBLL();
            ...
            if (school == null)
            {
                ...
                StudentTest lis = studentTestBLL.GetAll().Where(x => x.StudentId == Convert.ToInt32(StudentId) && x.TestId == 13).OrderByDescending(x => x.StudentTestId).FirstOrDefault();
        ...
        [WebMethod()]
        public static String[] TOEFLPaperbasedSave(string TestId, string Reading, string Listening, string Speaking, string Writing, string Total, string Date, string StudentTestId, string StudentId)
        {
            string str = string.Empty;
            StudentTestBLL studentTestBLL = new StudentTestBLL();
            StudentBLL studentBll = new StudentBLL();
            ...
            if (school == null)
            {
                ...
                StudentTest lis = studentTestBLL.GetAll().Where(x => x.StudentId == Convert.ToInt32(StudentId) && x.TestId == 14).OrderByDescending(x => x.StudentTestId).FirstOrDefault();
