<%@ Page Title="Edit Profile Student" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="EditProfile.aspx.cs" Inherits="SpotCollege.Account.EditProfile" EnableEventValidation="false" %>
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <div id="Dialog-Save" title="" style="display: none;">
                <p>
                    <span class="ui-icon ui-icon-alert" style="float: left; margin: 0 7px 20px 0;"></span>Your International
Test scores Have been saved
                </p>
            </div>
            <script type="text/javascript">
                $(document).ready(function () {
                    $("#Dialog-Save").attr('title', $("#MainContent_lbltitle").html());
                });
            </script>
            ...
            <div class="pattern_box box_space">
                <div class="row-fluid">
                    ...
                    <div class="span9">
                        <asp:Panel ID="pnlBasicDetail" runat="server" Visible="false">
                            <ul class="profile_form">
                                <li class="row-fluid">
                                    ...
                                    <div class="span3">
                                        ...
                                        ControlToValidate="txtMiddleName"  Display="Dynamic" ErrorMessage="Middle Name is Required" ValidationGroup="EditProfileValidation"></asp:RequiredFieldValidator>--%>
                                    </div>
                                    <div class="span3">
                                ...
                                <li class="row-fluid">
                                    ...
                                    <div class="span3">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator18" Display="Dynamic" runat="server" ControlToValidate="ddlCountry"
                                ...
                                <li class="row-fluid">
                                    ...
                                    <div class="span2">
                                        ...
                                        <%--                                    <asp:Label ID="lblPrimaryPhoneTypeValidation" runat="server" Text="Please Select Any"
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" Display="Dynamic" runat="server" ControlToValidate="ddlPhoneType"
                                            InitialValue="0" CssClass="field-validation-error" ErrorMessage="Please Select Phone Type"
                                            ValidationGroup="EditProfileValidation"></asp:RequiredFieldValidator>
                                    ...
                                    <div class="span2">
                                        <asp:TextBox ID="txtAreaCode" runat="server" placeholder="Area Code" MaxLength="10"></asp:TextBox>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator51" CssClass="field-validation-error"
                                            ValidationExpression="\d{0,10}" runat="server" ControlToValidate="txtAreaCode"
                                            ErrorMessage="Invalid Number" ValidationGroup="EditProfileValidation" Display="Dynamic"></asp:RegularExpressionValidator>
                                    </div>

                                    <div class="span2">
                                        <asp:TextBox ID="txtPrimaryNumber" runat="server" placeholder="Number" MaxLength="10"></asp:TextBox>
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" CssClass="field-validation-error"
                                            ...
                                            ErrorMessage="Invalid Number" Display="Dynamic" ValidationGroup="EditProfileValidation"></asp:RegularExpressionValidator>
                                    </div>
                                </li>
                                <li class="row-fluid">
                                    <div class="span3">
                                    ...
                                    <div class="span2">
                                        <asp:TextBox ID="txtAreaCode2" runat="server" placeholder="Area Code" MaxLength="10"></asp:TextBox>
                                    ...
                                    <div class="span2">
                                        <asp:TextBox ID="txtSecondaryNumber" runat="server" placeholder="Number" MaxLength="10"></asp:TextBox>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator52" Display="Dynamic" CssClass="field-validation-error"
                                            ValidationExpression="\d{0,10}" runat="server" ControlToValidate="txtSecondaryNumber"
                                            ErrorMessage="Invalid Number" ValidationGroup="EditProfileValidation"></asp:RegularExpressionValidator>
                                    </div>
                                ...
                                <li class="row-fluid">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" CssClass="field-validation-error"
                                        ControlToValidate="txtBirthDate" ErrorMessage="Birth Date is Required" ValidationGroup="EditProfileValidation"></asp:RequiredFieldValidator>
                                </div>--%>
                                    <div class="span2">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator28" Display="Dynamic" runat="server" ControlToValidate="ddlday"
                                            InitialValue="0" CssClass="field-validation-error" ErrorMessage="Please Select Date"
                                            ValidationGroup="EditProfileValidation"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="span2">
                                ...
                                <li class="row-fluid">
                                    ...
                                    <div class="span3">
                                        ...
                                        <%--  <asp:Label ID="lblCountryOfCitizenshipCountryValidation" runat="server" Text="Please Select Any"
                                        Visible="false" CssClass="field-validation-error"></asp:Label>--%>
                                ...
                                <li class="row-fluid">
                                    ...
                                    <div class="span4">
                                        <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Text="Save & Continue" ValidationGroup="EditProfileValidation" CssClass="large_button" />
                                    </div>
                                </li>
                            </ul>
                        </asp:Panel>
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Delete" HeaderStyle-Width="7%" ItemStyle-Width="7%">
                                            <ItemTemplate>
                                                ...
                                                <a id='delete<%#Eval("StudentAcademicsId")%>' href="javascript:AcademicDelete('<%#Eval("StudentAcademicsId")%>')">Delete</a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                        ...
                        <asp:Panel ID="pnlEducationPreferences" runat="server" Visible="false">
                            <ul class="profile_form">
                                <li class="row-fluid">
                                    <div class="span3">
                                        <label>
                                ...
                                <li class="row-fluid">
                                    ...
                                    <div class="span3">
                                        <%-- <asp:TextBox ID="txtdesiredfieldstudy" runat="server"></asp:TextBox>--%>
                        ...
                        <asp:Panel ID="pnlProfileImage" Visible="false" runat="server">
                            <ul class="profile_form">
                                <li class="row-fluid">
                                    <div class="span2">
                                        <label>
                                ...
                                <asp:GridView ID="grvWorkHistory" runat="server" CssClass="simple_table box" AutoGenerateColumns="false" DataKeyNames="StudentWorkHistoryId"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Delete" HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkDeleteWorkHistory" runat="server" Text="Delete" OnClick="lnkDeleteWorkHistory_Click" OnClientClick="return confirm('Are you sure want to delete History?');"
                        ...
                        <asp:Panel ID="pnlCurricularActivies" runat="server" Visible="false">
                            <ul class="profile_form">
                                <li class="row-fluid">
                                    <div class="span3">
                                        <label>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator38" runat="server" ErrorMessage="Composite is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtComposite" ValidationGroup="ACTValidation">
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator6" CssClass="field-validation-error"
                                                            ...
                                                            ErrorMessage="Invalid Value" ValidationGroup="ACTValidation">
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator39" runat="server" ErrorMessage="English is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtEnglish" ValidationGroup="ACTValidation">
                                                        </asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator7" CssClass="field-validation-error"
                                                            ...
                                                            ErrorMessage="Invalid Ranking" ValidationGroup="ACTValidation">
                                                        </asp:RegularExpressionValidator>
                                                    </div>
                                                </li>
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator40" runat="server" ErrorMessage="Math is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtMath" ValidationGroup="ACTValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator41" runat="server" ErrorMessage="Reading is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtReading" ValidationGroup="ACTValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator42" runat="server" ErrorMessage="Science is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtScience" ValidationGroup="ACTValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator43" runat="server" ErrorMessage="Writing is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtWriting" ValidationGroup="ACTValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator45" runat="server" ErrorMessage="Reading is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtSATReading" ValidationGroup="SATValidation">
                                                        </asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator12" CssClass="field-validation-error"
                                                            ...
                                                            ErrorMessage="Invalid Ranking" ValidationGroup="SATValidation">
                                                        </asp:RegularExpressionValidator>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator46" runat="server" ErrorMessage="Math is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtSATMath" ValidationGroup="SATValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator47" runat="server" ErrorMessage="Writing is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtSATWriting" ValidationGroup="SATValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator48" runat="server" ErrorMessage="Composite is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtSATComposite" ValidationGroup="SATValidation">
                                                        </asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator15" CssClass="field-validation-error"
                                                            ...
                                                            ErrorMessage="Invalid Value" ValidationGroup="SATValidation">
                                                        </asp:RegularExpressionValidator>
                                                    </div>
                                                </li>
                                                <li class="row-fluid">
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator50" runat="server" ErrorMessage="Subject is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtAPSubject" ValidationGroup="APValidation">
                                                        </asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator16" CssClass="field-validation-error"
                                                            ...
                                                            ErrorMessage="Invalid Ranking" ValidationGroup="APValidation">
                                                        </asp:RegularExpressionValidator>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator51" runat="server" ErrorMessage="Score is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtAPScore" ValidationGroup="APValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator53" runat="server" ErrorMessage="Verbal Reasoning is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtGREVerbalReasoning" ValidationGroup="GREValidation">
                                                        </asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator18" CssClass="field-validation-error"
                                                            ...
                                                            ErrorMessage="Invalid Ranking" ValidationGroup="GREValidation">
                                                        </asp:RegularExpressionValidator>
                                                    </div>
                                                </li>
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator54" runat="server" ErrorMessage="Quantitative Reasoning is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtGREQuantitativeReasoning" ValidationGroup="GREValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator55" runat="server" ErrorMessage="Analytical Writing is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtGREAnalyticalWriting" ValidationGroup="GREValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator57" runat="server" ErrorMessage="Verbal is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtGMATVerbal" ValidationGroup="GMATValidation">
                                                        </asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator21" CssClass="field-validation-error"
                                                            ...
                                                            ErrorMessage="Invalid Ranking" ValidationGroup="GMATValidation">
                                                        </asp:RegularExpressionValidator>
                                                    </div>
                                                </li>
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator58" runat="server" ErrorMessage="Quantitative is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtGMATQuantitative" ValidationGroup="GMATValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator59" runat="server" ErrorMessage="Total is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtGMATTotal" ValidationGroup="GMATValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator60" runat="server" ErrorMessage="Analytical Writing is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtGMATAnalyticalWriting" ValidationGroup="GMATValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator62" runat="server" ErrorMessage="Subject is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtIBSubject" ValidationGroup="IBValidation">
                                                        </asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator25" CssClass="field-validation-error"
                                                            ...
                                                            ErrorMessage="Invalid Ranking" ValidationGroup="IBValidation">
                                                        </asp:RegularExpressionValidator>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator63" runat="server" ErrorMessage="Score is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtIBScore" ValidationGroup="IBValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator65" runat="server" ErrorMessage="Listening is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtIELTSListening" ValidationGroup="IELTSValidation">
                                                        </asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator27" CssClass="field-validation-error"
                                                            ...
                                                            ErrorMessage="Invalid Ranking" ValidationGroup="IELTSValidation">
                                                        </asp:RegularExpressionValidator>
                                                    </div>
                                                </li>
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator66" runat="server" ErrorMessage="Reading is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtIELTSReading" ValidationGroup="IELTSValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator67" runat="server" ErrorMessage="Writing is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtIELTSWriting" ValidationGroup="IELTSValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator68" runat="server" ErrorMessage="Speaking is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtIELTSSpeaking" ValidationGroup="IELTSValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator70" runat="server" ErrorMessage="Score is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtLSATScore" ValidationGroup="LSATValidation">
                                                        </asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator31" CssClass="field-validation-error"
                                                            ...
                                                            ErrorMessage="Invalid Ranking" ValidationGroup="LSATValidation">
                                                        </asp:RegularExpressionValidator>
                                                    </div>
                                                </li>
                                                <li class="row-fluid">
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator72" runat="server" ErrorMessage="Biology is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtMCATBiology" ValidationGroup="MCATValidation">
                                                        </asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator32" CssClass="field-validation-error"
                                                            ...
                                                            ErrorMessage="Invalid Ranking" ValidationGroup="MCATValidation">
                                                        </asp:RegularExpressionValidator>
                                                    </div>
                                                </li>
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator73" runat="server" ErrorMessage="Physics is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtMCATPhysics" ValidationGroup="MCATValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator74" runat="server" ErrorMessage="Verbal is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtMCATVerbal" ValidationGroup="MCATValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator75" runat="server" ErrorMessage="Writing is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtMCATWriting" ValidationGroup="MCATValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator77" runat="server" ErrorMessage="Reading is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtPSATReading" ValidationGroup="PSATValidation">
                                                        </asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator36" CssClass="field-validation-error"
                                                            ...
                                                            ErrorMessage="Invalid Ranking" ValidationGroup="PSATValidation">
                                                        </asp:RegularExpressionValidator>
                                                    </div>
                                                </li>
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator78" runat="server" ErrorMessage="Math is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtPSATMath" ValidationGroup="PSATValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator79" runat="server" ErrorMessage="Writing is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtPSATWriting" ValidationGroup="PSATValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator81" runat="server" ErrorMessage="Subject is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtSAT_IISubject" ValidationGroup="SAT2Validation">
                                                        </asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator39" CssClass="field-validation-error"
                                                            ...
                                                            ErrorMessage="Invalid Ranking" ValidationGroup="SAT2Validation">
                                                        </asp:RegularExpressionValidator>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator82" runat="server" ErrorMessage="Score is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtSAT_IIScore" ValidationGroup="SAT2Validation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator84" runat="server" ErrorMessage="Reading is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtTOEFLInternetbasedReading" ValidationGroup="TOEFLInternetbasedValidation">
                                                        </asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator41" CssClass="field-validation-error"
                                                            ...
                                                            ErrorMessage="Invalid Ranking" ValidationGroup="TOEFLInternetbasedValidation">
                                                        </asp:RegularExpressionValidator>
                                                    </div>
                                                </li>
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator85" runat="server" ErrorMessage="Listening is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtTOEFLInternetbasedListening" ValidationGroup="TOEFLInternetbasedValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator86" runat="server" ErrorMessage="Speaking is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtTOEFLInternetbasedSpeaking" ValidationGroup="TOEFLInternetbasedValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator87" runat="server" ErrorMessage="Writing is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtTOEFLInternetbasedWriting" ValidationGroup="TOEFLInternetbasedValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator88" runat="server" ErrorMessage="Total is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtTOEFLInternetbasedTotal" ValidationGroup="TOEFLInternetbasedValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator90" runat="server" ErrorMessage="Reading is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtTOEFLPaperbasedReading" ValidationGroup="TOEFLPaperbasedValidation">
                                                        </asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator46" CssClass="field-validation-error"
                                                            ...
                                                            ErrorMessage="Invalid Ranking" ValidationGroup="TOEFLPaperbasedValidation">
                                                        </asp:RegularExpressionValidator>
                                                    </div>
                                                </li>
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator91" runat="server" ErrorMessage="Listening is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtTOEFLPaperbasedListening" ValidationGroup="TOEFLPaperbasedValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator92" runat="server" ErrorMessage="Speaking is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtTOEFLPaperbasedSpeaking" ValidationGroup="TOEFLPaperbasedValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator93" runat="server" ErrorMessage="Writing is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtTOEFLPaperbasedWriting" ValidationGroup="TOEFLPaperbasedValidation">
                                                        </asp:RequiredFieldValidator>
                                                ...
                                                <li class="row-fluid">
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator94" runat="server" ErrorMessage="Total is Required"
                                                            CssClass="field-validation-error" ControlToValidate="txtTOEFLPaperbasedTotal" ValidationGroup="TOEFLPaperbasedValidation">
                                                        </asp:RequiredFieldValidator>
    ...
    <script type="text/javascript">
                    ...
                    success: function (msg) {
                        ...
                        if (data[2] == "add") {
                            ...
                            if (document.getElementById("MainContent_dlACT") != null) {
                                var v = '<br/><span><li><a id="editact' + data[0] + '" href="javascript:OpenACTEdit(' + data[0] + ')">ACT-' + data[1] + '</a> <a href="javascript:ACTDelete(' + data[0] + ')" id="deleteact' + data[0] + '" class="delete"> Delete</a></li></span>';
                                $("#MainContent_dlACT").append(v);
                            }
                            else {
                                var v = '<span id="MainContent_dlACT"><span><li><a id="editact' + data[0] + '" href="javascript:OpenACTEdit(' + data[0] + ')">ACT-' + data[1] + '</a> <a href="javascript:ACTDelete(' + data[0] + ')" id="deleteact' + data[0] + '" class="delete"> Delete</a></li></span></span>';
                                $("#ulACT").append(v);
                            }
                        }
                        else if (data[2] == "edit") {
                            $("#editact" + data[0]).text("ACT-" + data[1]);
                            window.location.href = "EditProfile.aspx?sec=IntTest";
                        }
                        else { }
                        $("#LoadingImage").hide();
                        $("#MainContent_txtComposite").val("");
                    ...
                    "Yes": function () {
                        if (Page_IsValid) {
                            ...
                            $.ajax({
                                ...
                                beforeSend: function () { $("#LoadingImage").show(); },
                                complete: function () { $("#LoadingImage").hide(); },
                                url: "EditProfile.aspx/ACTDelete",
                    ...
                    success: function (msg) {
                        ...
                        if (data[2] == "add") {
                            if (document.getElementById("MainContent_dlSAT") != null) {
                                ...
                                var v = '<span id="MainContent_dlSAT"><span><li><a id="editsat' + data[0] + '" href="javascript:OpenSATEdit(' + data[0] + ')">SAT-' + data[1] + '</a> <a href="javascript:SATDelete(' + data[0] + ')" id="deletesat' + data[0] + '" class="delete"> Delete</a></li></span></span>';
                                $("#ulSAT").append(v);
                            }
                        }
                        else if (data[2] == "edit") {
                    ...
                    "Yes": function () {
                        if (Page_IsValid) {
                            ...
                            $.ajax({
                                ...
                                beforeSend: function () { $("#LoadingImage").show(); },
                                complete: function () { $("#LoadingImage").hide(); },
                                url: "EditProfile.aspx/SATDelete",
                                data: JSON.stringify(HighSchool),
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                success: function (msg) {
                    ...
                    success: function (msg) {
                        ...
                        if (data[2] == "add") {
                            if (document.getElementById("MainContent_dlAP") != null) {
                                var v = '<br/><span><li><a id="editap' + data[0] + '" href="javascript:OpenAPEdit(' + data[0] + ')">AP-' + data[1] + '</a> <a href="javascript:APDelete(' + data[0] + ')" id="deleteap' + data[0] + '" class="delete"> Delete</a></li></span>';
                                $("#MainContent_dlAP").append(v);
                            } else {
                                var v = '<span id="MainContent_dlACT"><span><li><a id="editap' + data[0] + '" href="javascript:OpenAPEdit(' + data[0] + ')">AP-' + data[1] + '</a> <a href="javascript:APDelete(' + data[0] + ')" id="deleteap' + data[0] + '" class="delete"> Delete</a></li></span></span>';
                                $("#ulAP").append(v);
                            }
                        }
                        else if (data[2] == "edit") {
                    ...
                    success: function (msg) {
                        ...
                        if (data[2] == "add") {
                            if (document.getElementById("MainContent_dlGRE") != null) {
                                var v = '<br/><span><li><a id="editgre' + data[0] + '" href="javascript:OpenGREEdit(' + data[0] + ')">GRE-' + data[1] + '</a> <a href="javascript:GREDelete(' + data[0] + ')" id="deletegre' + data[0] + '" class="delete"> Delete</a></li></span>';
                                $("#MainContent_dlGRE").append(v);
                            }
                            else {
                                var v = '<span id="ulGRE"><span><li><a id="editgre' + data[0] + '" href="javascript:OpenGREEdit(' + data[0] + ')">GRE-' + data[1] + '</a> <a href="javascript:GREDelete(' + data[0] + ')" id="deletegre' + data[0] + '" class="delete"> Delete</a></li></span></span>';
                                $("#ulGRE").append(v);
                            }
                    ...
                    success: function (msg) {
                        ...
                        if (data[2] == "add") {
                            if (document.getElementById("MainContent_dlGMAT") != null) {
                                var v = '<br/><span><li><a id="editgmat' + data[0] + '" href="javascript:OpenGMATEdit(' + data[0] + ')">GMAT-' + data[1] + '</a> <a href="javascript:GMATDelete(' + data[0] + ')" id="deletegmat' + data[0] + '" class="delete"> Delete</a></li></span>';
                                $("#MainContent_dlGMAT").append(v);
                            }
                            else {
                                var v = '<span id="MainContent_dlGMAT"><span><li><a id="editgmat' + data[0] + '" href="javascript:OpenGMATEdit(' + data[0] + ')">GMAT-' + data[1] + '</a> <a href="javascript:GMATDelete(' + data[0] + ')" id="deletegmat' + data[0] + '" class="delete"> Delete</a></li></span></span>';
                                $("#ulGMAT").append(v);
                            }
                        }
                        else if (data[2] == "edit") {
                    ...
                    success: function (msg) {
                        ...
                        if (data[2] == "add") {
                            if (document.getElementById("MainContent_dlIB") != null) {
                                ...
                                var v = '<span id="MainContent_dlIB"><span><li><a id="editib' + data[0] + '" href="javascript:OpenIBEdit(' + data[0] + ')">IB-' + data[1] + '</a> <a href="javascript:IBDelete(' + data[0] + ')" id="deleteib' + data[0] + '" class="delete"> Delete</a></li></span></span>';
                                $("#ulIB").append(v);
                            }
                        }
                        else if (data[2] == "edit") {
        ...
        $("#MainContent_btnIELTSSave").click(function () {
            if (Page_IsValid) {
                ...
                $.ajax({
                    ...
                    beforeSend: function () { $("#LoadingImage").show(); },
                    complete: function () { $("#LoadingImage").hide(); },
                    url: "EditProfile.aspx/IELTSSave",
                    ...
                    success: function (msg) {
                        ...
                        if (data[2] == "add") {
                            if (document.getElementById("MainContent_dlIELTS") != null) {
                                ...
                                var v = '<span id="MainContent_dlIELTS"><span><li><a id="editielts' + data[0] + '" href="javascript:OpenIELTSEdit(' + data[0] + ')">IELTS-' + data[1] + '</a> <a href="javascript:IELTSDelete(' + data[0] + ')" id="deleteielts' + data[0] + '" class="delete"> Delete</a></li></span></span>';
                                $("#ulIELTS").append(v);
                            }
                        }
                        else if (data[2] == "edit") {
                    ...
                    success: function (msg) {
                        ...
                        if (data[2] == "add") {
                            if (document.getElementById("MainContent_dlLSAT") != null) {
                                ...
                                var v = '<span id="MainContent_dlLSAT"><span><li><a id="editlsat' + data[0] + '" href="javascript:OpenLSATEdit(' + data[0] + ')">LSAT-' + data[1] + '</a> <a href="javascript:LSATDelete(' + data[0] + ')" id="deletelsat' + data[0] + '" class="delete"> Delete</a></li></span></span>';
                                $("#ulLSAT").append(v);
                            }
                        }
                        else if (data[2] == "edit") {
                    ...
                    success: function (msg) {
                        ...
                        if (data[2] == "add") {
                            if (document.getElementById("MainContent_dlMCAT") != null) {
                                ...
                                var v = '<span id="MainContent_dlMCAT"><span><li><a id="editmcat' + data[0] + '" href="javascript:OpenMCATEdit(' + data[0] + ')">MCAT-' + data[1] + '</a> <a href="javascript:MCATDelete(' + data[0] + ')" id="deletemcat' + data[0] + '" class="delete"> Delete</a></li></span></span>';
                                $("#ulMCAT").append(v);
                            }
                        }
                        else if (data[2] == "edit") {
                    ...
                    success: function (msg) {
                        ...
                        if (data[2] == "add") {
                            if (document.getElementById("MainContent_dlPSAT") != null) {
                                ...
                                var v = '<span id="MainContent_dlPSAT"><span><li><a id="editpsat' + data[0] + '" href="javascript:OpenPSATEdit(' + data[0] + ')">PSAT-' + data[1] + '</a> <a href="javascript:PSATDelete(' + data[0] + ')" id="deletepsat' + data[0] + '" class="delete"> Delete</a></li></span></span>';
                                $("#ulPSAT").append(v);
                            }
                        }
                        else if (data[2] == "edit") {
                    ...
                    success: function (msg) {
                        ...
                        if (data[2] == "add") {
                            if (document.getElementById("MainContent_dlSAT2") != null) {
                                ...
                                var v = '<span id="MainContent_dlSAT2"><span><li><a id="editsat2' + data[0] + '" href="javascript:OpenSAT2Edit(' + data[0] + ')">SAT-II-' + data[1] + '</a> <a href="javascript:SAT2Delete(' + data[0] + ')" id="deletesat2' + data[0] + '" class="delete"> Delete</a></li></span></span>';
                                $("#ulSAT2").append(v);
                            }
                        }
                        else if (data[2] == "edit") {
        ...
        $("#MainContent_btnTOEFLInternetbasedSave").click(function () {
            if (Page_IsValid) {
                ...
                $.ajax({
                    ...
                    beforeSend: function () { $("#LoadingImage").show(); },
                    complete: function () { $("#LoadingImage").hide(); },
                    url: "EditProfile.aspx/TOEFLInternetbasedSave",
                    ...
                    success: function (msg) {
                        ...
                        if (data[2] == "add") {
                            if (document.getElementById("MainContent_dlTOEFLInternetbased") != null) {
                                ...
                                var v = '<span id="MainContent_dlTOEFLInternetbased"><span><li><a id="edittoefli' + data[0] + '" href="javascript:OpenTOEFLInternetbasedEdit(' + data[0] + ')">TOEFLInternetbased-' + data[1] + '</a> <a href="javascript:TOEFLInternetbasedDelete(' + data[0] + ')" id="deletetoefli' + data[0] + '"class="delete"> Delete</a></li></span></span>';
        ...
        $("#MainContent_btnTOEFLPaperbasedSave").click(function () {
            if (Page_IsValid) {
                ...
                $.ajax({
                    ...
                    beforeSend: function () { $("#LoadingImage").show(); },
                    complete: function () { $("#LoadingImage").hide(); },
                    url: "EditProfile.aspx/TOEFLPaperbasedSave",
                    ...
                    success: function (msg) {
                        ...
                        if (data[2] == "add") {
                            if (document.getElementById("MainContent_dlTOEFLPaperbased") != null) {
                                ...
                                var v = '<span id="MainContent_dlTOEFLPaperbased"><span><li><a id="edittoeflp' + data[0] + '" href="javascript:OpenTOEFLPaperbasedEdit(' + data[0] + ')">TOEFLPaperbased-' + data[1] + '</a> <a href="javascript:TOEFLPaperbasedDelete(' + data[0] + ')" id="deletetoeflp' + data[0] + '" class="delete"> Delete</a></li></span></span>';
        ...
        function AcademicDelete(studentAcademicId) {
            $("#dialog-confirm").dialog({
                open: function (event, ui) { $(".ui-dialog-titlebar-close .ui-button-text").hide(); },
                resizable: false,
                height: 140,
                    ...
                    "Yes": function () {
                        if (Page_IsValid) {
                            ...
                            $.ajax({
                                ...
                                beforeSend: function () { $("#LoadingImage").show(); },
                                complete: function () { $("#LoadingImage").hide(); },
                                url: "EditProfile.aspx/AcademicDelete",
                                data: JSON.stringify(sat2),
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                success: function (msg) {
                                    $("#delete" + studentAcademicId).parent().parent().remove();
