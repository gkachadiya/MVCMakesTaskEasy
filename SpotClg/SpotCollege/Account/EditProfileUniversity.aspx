<%@ Page Title="Edit University Profile" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditProfileUniversity.aspx.cs" ValidateRequest="false" Inherits="SpotCollege.Account.EditProfileUniversity" %>
                ...
                <asp:Panel ID="pnlBasicDetail" runat="server" Visible="true" CssClass="span9">
                    <ul class="profile_form">
                        ...
                        <li class="row-fluid">
                            ...
                            <div class="span4">
                                <asp:TextBox runat="server" ID="txtUserName" Enabled="false" CssClass="address" />
                                ...
                                <asp:Label ID="duplicateUser" runat="server" CssClass="field-validation-error" Visible="False">UserName already exist in Record. Please Choose Any other..!</asp:Label>
                            </div>
                        </li>
                        ...
                        <li class="row-fluid">
                            ...
                            <div class="span4">
                                <%--<asp:DropDownList ID="ddlEstablishYear" runat="server" CssClass="ddladdress"></asp:DropDownList>--%>
                    ...
                    <ul class="profile_form">
                        <li class="row-fluid">
                            ...
                            <div class="span2">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" Display="Dynamic" runat="server" ValidationExpression="[\d]{1,8}-[\d]{1,8}" CssClass="field-validation-error" ErrorMessage="please enter valid range" ControlToValidate="txtUnderGraduateFee" ValidationGroup="EditCostForInternationalStudent"></asp:RegularExpressionValidator>
                        ...
                        <li class="row-fluid">
                            ...
                            <div class="span2">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" Display="Dynamic" runat="server" ValidationExpression="[\d]{1,8}-[\d]{1,8}" CssClass="field-validation-error" ErrorMessage="please enter valid range" ControlToValidate="txtGraduateFee" ValidationGroup="EditCostForInternationalStudent"></asp:RegularExpressionValidator>
                        ...
                        <li class="row-fluid">
                            ...
                            <div class="span2">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator5" Display="Dynamic" runat="server" ValidationExpression="[\d]{1,8}-[\d]{1,8}" CssClass="field-validation-error" ErrorMessage="please enter valid range" ControlToValidate="txtBookFee" ValidationGroup="EditCostForInternationalStudent"></asp:RegularExpressionValidator>
                        ...
                        <li class="row-fluid">
                            ...
                            <div class="span2">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator6" Display="Dynamic" runat="server" ValidationExpression="[\d]{1,8}-[\d]{1,8}" CssClass="field-validation-error" ErrorMessage="please enter valid range" ControlToValidate="txtBoardFee" ValidationGroup="EditCostForInternationalStudent"></asp:RegularExpressionValidator>
