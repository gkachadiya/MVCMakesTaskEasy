<%@ Page Title="Careers" Language="C#" AutoEventWireup="true" CodeBehind="Careers.aspx.cs" Inherits="SpotCollege.Careers" %>
                            ...
                            <div class="span8">
                                <nav id="nav-wrap">
                                    <ul class="navigation" id="nav">
                                        ...
                                        <li class="navi_active"><a href="#">Careers</a></li>
                                    </ul>
                                </nav>
                            </div>
                            <div class="span1">
